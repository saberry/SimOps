...
Amat <- rbind(all_neck = c(1, 1, 1),
              all_body = c(1, 1, 1),
              pro_ultra_tuner = c(0, 1, 1),
              pro_ultra_elec = c(0, 1, 1),
              pro_ultra_bridge = c(0, 1, 1),
              performer_tuner = c(1, 0, 0),
              performer_elec = c(1, 0, 0),
              performer_bridge = c(1, 0, 0),
              proII_demand = c(0, 1, 0))
...
Remember that whole "no promise of optimality"? Looking us right in the faces here.
...
If specified correctly, this problem should run into trouble: mostly because there is more demand than inventory. If you get answers with the question as written something might be weird:
...
With only 600 engines available, this model runs into problems with those demand constraints. To get this problem to solve, something has to change.
